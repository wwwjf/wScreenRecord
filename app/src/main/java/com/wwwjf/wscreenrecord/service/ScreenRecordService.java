package com.wwwjf.wscreenrecord.service;
...
import com.wwwjf.wscreenrecord.R;
import com.wwwjf.wscreenrecord.utils.CommonUtil;
import com.wwwjf.wscreenrecord.utils.FileUtil;
...
public class ScreenRecordService extends Service implements Handler.Callback{
    ...
    private int mRecordWidth = CommonUtil.getScreenHeight();
    private int mRecordHeight = CommonUtil.getScreenWidth();
...
//            FileUtil.scanFile(this,new File(mRecordFilePath));
        }
